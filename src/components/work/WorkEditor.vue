...
const emit = defineEmits<{
  submit: [data: { title: string; content: string; work_date: string; period: string; category: string }]
  cancel: []
}>()
  ...
  <div class="work-editor">
    <NCard>
      <div class="editor-field">
        <label class="editor-label">工作内容</label>
        <NInput
      ...
      <div class="editor-row">
        ...
        <div class="editor-field editor-field--half">
          <label class="editor-label">时间段</label>
          <NSelect
      ...
      <div class="editor-field">
        <label class="editor-label">详细记录（选填）</label>
        <NInput
