    ...
    <div class="result-card__inner">
      ...
      <div class="result-card__body">
        <div class="result-card__header">
          <span class="result-card__type-label">
        ...
        <span
          v-if="result.type === 'work' && result.extra"
          class="result-card__extra"
        >
          {{ periodLabels[result.extra] || result.extra }}
        </span>
        <span
          v-if="result.description"
          class="result-card__desc"
        >
          {{ result.description }}
        </span>
        <span
          v-if="(result.type === 'photo' || result.type === 'location') && result.extra"
          class="result-card__extra"
        >
          {{ result.type === 'photo' ? '📍 ' : '' }}{{ result.extra }}
        </span>
      </div>
    </div>
  </NCard>
